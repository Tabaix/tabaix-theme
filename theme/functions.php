...
require_once get_template_directory() . '/inc/preset-palettes.php';
require_once get_template_directory() . '/inc/ajax.php';

function tabaix_enqueue_ajax_scripts() {
    wp_localize_script('tabaix-main', 'tabaixAjax', array(
        'ajaxurl' => admin_url('admin-ajax.php'),
        'nonce' => wp_create_nonce('tabaix_ajax_nonce')
    ));
}
add_action('wp_enqueue_scripts', 'tabaix_enqueue_ajax_scripts', 100);
