...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Retrieve customizer endpoint or default to localhost
  const VERCEL_API_URL = '<?php echo esc_url(get_theme_mod("tabaix_seo_api_url", "http://localhost:3000/api/audit")); ?>'; 
